...
<head>
    ...
    <title>Annuaire Institutionnel</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: 'Segoe UI', sans-serif; background: var(--gray-light); color: #334155; }
        ...
        .nav-link {
            ...
            padding: 0.4rem 0.9rem; border-radius: 6px; font-size: 0.88rem;
        ...
        .btn-logout {
            ...
            color: #fff; padding: 0.35rem 0.8rem; border-radius: 6px;
        ...
        /* ── Page wrapper ── */
        .page-wrapper { max-width: 1280px; margin: 0 auto; padding: 2rem 1.5rem; }
    </style>
</head>
<body>
...
{{-- Navbar --}}
<nav class="navbar">
    <a href="{{ route('annuaire.index') }}" class="navbar-brand">Annuaire Institutionnel</a>

    <div class="navbar-nav">
        <a href="{{ route('annuaire.index') }}"
           class="nav-link {{ request()->routeIs('annuaire.*') ? 'active' : '' }}">
            Annuaire
        </a>
